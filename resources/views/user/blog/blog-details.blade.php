    ...
    <section class="blog-details">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <h2 style="color: #fb0000;font-weight: 500;font-size: 30px;" class="text-center mt-3 mb-5">Blog Details</h2>
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <h3 class="text-center mb-4" style="color: #fb0000;font-weight: 500; font-size: 35px">{{$blog->title}}</h3>
    ...
    <div class="page-section bg-light">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <h2 style="color: #fb0000;font-weight: 500;font-size: 30px;" class="text-center mt-1 mb-2">Related Blog</h2>
