                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input type="text" name="service_name" 
                                           ...
                                           placeholder="Service Name" value="{{ old('service_name', $testRate->service_name) }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input type="text" name="department_name" 
                                           ...
                                           placeholder="Department Name" value="{{ old('department_name', $testRate->department_name) }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input type="text" name="category" 
                                           ...
                                           placeholder="Category" value="{{ old('category', $testRate->category) }}">
